...
let schedule_type_list_str ="<none|default|verification_epr>"
...
let cl_cmp_type_list_str = "<[((+|-)(age|num_var|num_symb|num_lits|ground|conj_dist|conj_symb|max_atom_input_occur|horn|epr|has_eq)^+]>"
...
let sat_out_model_type_str = "<small|pos|neg|implied|debug|none>"
...
let named_option_verification_epr () = 
  {options_name = "Option_verification_epr"; options = (option_verification_epr())}
